Feature: HU1 - Agregar días y/o horas laborales a una fecha y hora dados
...
Examples:
  ...
  | 2025-10-10T14:00:00Z      | 1    | 2025-10-07T14:00:00Z   |
...
Examples:
  ...
  | 2025-10-12T15:00:00Z      | 3     | 2025-10-10T19:00:00Z   |
...
Scenario Outline: Donald provee a la API <init-datetime> como fecha y hora iniciales y le suma <days> y <hours> horas
  When Donald provee una fecha y hora iniciales de <init-datetime> en UTC
    And Donald suma <days> número de dias
    And Donald suma <hours> número de horas
  Then Donald recibe como respuesta <result-datetime> en UTC
...
Scenario Outline: Donald provee a la API <init-datetime> como fecha y hora iniciales y le suma <days> y <hours> horas
  When Donald provee una fecha y hora iniciales de <init-datetime> en UTC
  Then Donald recibe como respuesta un error indicando que no envió dias ni horas a sumar
...
Examples:
  ...
  |                      |      |       | "InvalidParameters", "No se enviaron horas ni días a adicionar" |
